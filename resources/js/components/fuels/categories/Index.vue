        ...
        <section class="content" v-if="!add_category">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Fuel Categories</h3>
    ...
    export default {
        ...
        methods:{
            ...
            editCategory(category){
                this.$store.dispatch('updateFuelCategory',category)
                    .then(() =>{
                        this.editing=true;
            ...
            listen(){
                eventBus.$on('listFuelCategories',(category) =>{
                ...
                eventBus.$on('updateFuelCategory',(category)=>{
                    this.add_category = false;
                    this.editing = false;
                    for (let i=0;i<this.tableData.length;i++){
